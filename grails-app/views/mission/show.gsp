...
<html>
    ...
    <body>
        ...
        <div id="show-mission" class="content scaffold-show" role="main">
            ...
            <f:display bean="mission" />
            <g:form resource="${this.mission}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.mission}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
